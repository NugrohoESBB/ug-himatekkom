...
if($status=="OK"){
$qb=mysqli_query($con,"update sitecontact set phone='$phone', email='$email' where id=1");
              ...
              <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="phone"  value="<?php print $phone ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="email"  value="<?php print $email ?>">
                                                        </div>
                                                    </div>
