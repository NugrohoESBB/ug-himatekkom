...
?>
                                                        ...
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1">Total Social</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                    <?php
$result = mysqli_query($con,"SELECT count(*) FROM event");
$rowx = mysqli_fetch_row($result);
$nux = $rowx[0];

?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Event</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                    <?php
$result = mysqli_query($con,"SELECT count(*) FROM profile");
$rod = mysqli_fetch_row($result);
$nud = $rod[0];

?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Profile</p>
