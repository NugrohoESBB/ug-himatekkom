...
?>
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="100">
    ...
    <nav style="z-index: 99" class="navbar site-nav dark navbar-expand-lg bg-light navbar-light">
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <img src="uploads/logo/<?php print $xfile?>" width="70" class="img-fluid me-2">
          <div class="d-block">
            <a class="navbar-brand logo" href="../index.php"><?php print $web_title ?></a>
          </div>
        </div>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../tentang_hima.php"
                >Profile Pengurus</a
              >
            </li>
            
            <li class="nav-item">
              <a class="nav-link active-link" href="../forum_aspirasi.php">Forum</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="../info_alumni.php">Info & Berita</a>
            </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="../layanan_codigo.php">Codigo</a></li>
              <li><a class="dropdown-item" href="../layanan_codigame.php">Codigame</a></li>
              <li><a class="dropdown-item" href="../layanan_partnership.php">Partnership</a></li>
            </ul>
          </li>
        </div>
    ...
    <div class="untree_co-section mt-5 mb-5">
...
$ccom = mysqli_real_escape_string($con,$_POST['ccom']);

if($status=="OK"){
$qb=mysqli_query($con,"INSERT INTO cumatekkom_text (cname, ccom) VALUES ('$cname','$ccom')");
...
<div class='alert alert-danger alert-dismissible alert-outline fade show'>
    ...
    <form action="" method="post" enctype="multipart/form-data">
      <div class="forum-comment mx-3 mt-5 mb-5">

        <div class="mb-3">
          <label for="firstnameInput" class="form-label">Nama Lengkap</label>
          <input type="text" class="form-control" id="firstnameInput" name="cname" placeholder="Masukkan nama anda..">
        </div>
        <div class="mb-3 ">
          <label for="firstnameInput" class="form-label">Komentar</label>
          <textarea class="form-control" id="exampleFormControlTextarea5" name="ccom" rows="3"></textarea>
        </div>

        <button type="submit" name="save" class="btn btn-primary w-100">KIRIM</button>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-5 mb-5">
            <div class="d-flex align-items-center">
              <img src="uploads/logo/<?php print $xfile?>" width="53" class="img-fluid me-2">
